...
const whatsappLink = (path?: string) => {
    ...
    return `https://wa.me/5512997347247?text=Ol%C3%A1%2C%20acessei%20o%20site%20do%20Studio%20Torroja%20e%20gostaria%20de%20um%20or%C3%A7amento%21`
}

const instagramLink = (path?: string) => {

    return `https://www.instagram.com/studio.torroja/`
}

const mailLink = (path?: string) => {

    return `mailto:studio.torroja@gmail.com`
}
